...
<html class="no-js">
  <head>
    ...
    <title>404 Not Found | Isy Web</title>
    <meta name="description" content="isy web, jasa pembuatan website, jasa pembuatan website murah">
              ...
              <div class="navbar-header">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="<?=base_url(); ?>works">How it works</a></li>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <div class="block">
                  <h1>404 Not Found</h1>
                  <p>Maaf halaman yang anda ingin akses tidak ditemukan.</p>
                </div>
              </div>
            </div>
          </div>
